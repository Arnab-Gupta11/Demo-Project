...
const Footer = () => {
    return (
        ...
        <footer className="pt-12 pb-4 border-t border-gray-100 mt-16 px-[5%] max-w-7xl mx-auto">
            <div className=" mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-0 pb-10">
                    ...
                    <div className="flex-1 mb-8 md:mb-0 flex flex-col justify-center items-center">
                    ...
                    <div className="flex-1 mb-8 md:mb-0 flex flex-col justify-start items-center">
                        <div>
